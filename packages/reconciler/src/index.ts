// TEMPORARY FIX: Hardcode to use reconciler-23 for React 18
// The dynamic version detection doesn't work correctly when there are multiple
// React versions in the monorepo (pnpm resolves react-reconciler with the wrong React version)
...
export default createRendererForReact18AndLess;
